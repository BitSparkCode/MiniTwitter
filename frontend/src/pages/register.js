...
export function renderRegister() {
  ...
  `;
    const usernameEl = page.querySelector('#reg-username');
    const passwordEl = page.querySelector('#reg-password');
    const confirmEl = page.querySelector('#reg-confirm');
    const msgEl = page.querySelector('#reg-msg');
    ...
    [usernameEl, passwordEl, confirmEl].forEach((el) => el.addEventListener('keydown', (e) => { if (e.key === 'Enter')
        submit(); }));
    usernameEl.focus();
}
